            ...
            <div class="inner">
              <?php
                ...
                foreach($stmt as $srow){
                    	...
                    	$stmt_user_item->execute(['id'=>$srow['id_user']]);
                ...
                echo "<h3>RWF ".number_format_short($total, 2)."</h3>";
              ?>
              <p>Total Sales</p>
            </div>
            <div class="icon">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                ...
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM products WHERE shop=:shop");
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                ...
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM users WHERE company= :company");
            ...
            <div class="inner">
              <?php
                ...
                foreach($stmt as $trow){
                    $stmt_user_item = $conn->prepare("SELECT * FROM users WHERE id=:id ");
                    	$stmt_user_item->execute(['id'=>$trow['user_id']]);
                    	$user_id = $stmt_user_item->fetch();
                        $site_item=$user_id['company'];
  ...
  for( $m = 1; $m <= 12; $m++ ) {
    try{
      ...
      foreach($stmt as $srow){
         ...
         $stmt_user_item = $conn->prepare("SELECT * FROM users WHERE id=:id ");
        $stmt_user_item->execute(['id'=>$srow['user_id']]);
        $user_id = $stmt_user_item->fetch();
        $site_item=$user_id['company'];
