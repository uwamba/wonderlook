 ...
 <div>
      <div class="box box-solid" >
	    ...
	    <button type="button" class="btn btn-secondary btn-lg btn-block">Category</button>
	  	...
	  	<div class="box-body">
	  	  <ul class="list-group" style="list-style-type:none; background-color: #;" >
		   <?php
                ...
                try{
                  ...
                  foreach($stmt as $row){
                   ?>
                   <li style="margin-bottom:2px"><a href="category.php?category=<?php echo $row['cat_slug']; ?>" class="list-group-item list-group-item-action active" style="background-color: #000000; important"><?php echo $row['name']; ?></a></li>
				   <?php
...
<!-- As a heading -->
  ...
  <img class="card-img-top" src="images/side.jpeg" alt="MTN MOMO PAY" width="100%" height="auto">
	...
	<div class="box box-solid">
	  	...
	  	<div class="box-body">
	    	<img src="images/momo.jpeg" alt="MTN MOMO PAY" width="100%" height="auto">
	  	</div>
	</div>
