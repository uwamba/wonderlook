  ...
  <nav class="navbar navbar-static-top" style="background-color: #000; ">
    <div class="container" >
      <div class="navbar-header">
         <a href="./index.php" class="navbar-brand"><img  src="images/Wonder Look gold no BG.png"  width="90px"    height="35px" style=" border-radius: 5px; " /></a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown" >
            ...
            <ul class="dropdown-menu" role="menu" style="background-color:#000; important">
              <li><a href=""> Tel:+250786138376</a></li>
              <li><a href="">info@wonderlook.rw</a></li>
            </ul>
          </li>
        </ul>
         <ul class="nav navbar-nav">
