  ...
  <nav class="navbar navbar-static-top" style="background-color: #000; ">
    <div class="container" >
      <div class="navbar-header">
         <a href="./index.php" class="navbar-brand"><img  src="images/logo.png"  width="150px"    height="50px" style="padding-bottom:15px; padding-left:10px;" /></a>
      ...
      <!-- Collect the nav links, forms, and other content for toggling -->
       <form method="POST" class="navbar-form navbar-left" action="search.php" style="padding-top:7px;">
          <div class="input-group" id="searchform">
            ...
            <select  id="dropdown" style="background-color: #FFF;height:35px; important">
            <option value="">Product Category</option>
             ...
             <input type="text" class="form-control" id="navbar-search-input" name="keyword" placeholder="Search for Product" style="background-color: #FFF;height:33px; margin-top:1px; important" required>
              <span  id="spanned2" >
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown" >
            ...
            <ul class="dropdown-menu" role="menu" style="background-color:#000; important">
              <li><a href=""> Tel:+250788308398</a></li>
              <li><a href="">Sales@readinstore.com </a></li>
              <li><a href="">info@readinstore.com</a></li>
            </ul>
          </li>
        </ul>
         <ul class="nav navbar-nav">
